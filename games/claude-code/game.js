...
class ClaudeCodeGame {
    constructor() {
        ...
        this.mentorMessages = {
            welcome: [
                "היי! אני קלוד, ואני כאן ללוות אותך במסע לשליטה ב-Claude Code!",
                "ברוכים הבאים! מוכנים להפוך ל-Claude Code Masters?",
                "שמח לראות אותך! יחד נלמד איך לעבוד עם AI ישירות מהטרמינל."
            ],
            moduleIntro: {
